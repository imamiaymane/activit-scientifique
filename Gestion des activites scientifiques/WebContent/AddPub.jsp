					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form action="<%=request.getContextPath()%>/AddPub" method="post" enctype="multipart/form-data">
										<div class="item form-group">
												...
												<div class="col-md-6 col-sm-6 ">
													<select class="form-control"
														name="Type" >
														<option></option>
														<option>article de conférence</option>
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" name="titre" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Abstract<span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<textarea id="message" required="required" class="form-control" name="abstract" data-parsley-trigger="keyup"
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">auteur<span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" name="auteur" required="required" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" name="auteur2"  class="form-control ">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" name="auteur3" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
