							...
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<div><p style="color:red;"><c:out value="${nomEq}"/></p></div>
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">laboratoire :<span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<select class="form-control"
													name="nom_labo" required>
													<c:forEach items="${Laboratoires}" var="labo">
													<option value="${labo.getId_laboratoire()}">${labo.getNom_labo()}</option>
													</c:forEach>
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Chef d'équipe :<span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<select class="form-control"
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Ajouter des chercheurs (minimum 4):<span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<select class="form-control"
